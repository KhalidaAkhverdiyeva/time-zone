...
const HeroSecText = () => {
  return (
    <div>
        <h1 className='text-[96px] font-[700] text-[#0B1C39] mb-[26px]'>Select Your New Perfect Style</h1>
        <p className='mb-[60px] pr-[50px] text-[18px]'>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat is aute irure.</p>
