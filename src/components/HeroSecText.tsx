...
const HeroSecText = () => {
  return (
    <div className="overflow-hidden p-[40px] md:p-[0px]">
      <h1 className="text-[32px] md:text-[96px] font-[700] text-[#0B1C39] mb-[26px] animate-slideIn">
        Select Your New Perfect Style
      </h1>
      <p className="mb-[60px] pr-[50px] text-[18px] animate-slideInP">
