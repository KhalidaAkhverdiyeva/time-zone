...
const PopularWatchCard:FC<WatchCardProp> = ({img}) => {
  return (
    <div className='relative'>
        <div className='relative overflow-hidden mb-[20px] group'>
                <img className='border-b-solid border-b-[#ff2020] border-b-[3px] w-full' src={img} alt="" />
        ...
        <div><p className='text-[24px] font-[700] text-center text-[#444444]'>Thermo Ball Etip Gloves</p></div>
        <div><p className='text-[18px] text-center text-[#444444] font-[500]'>$ 45,743</p></div>
    </div>
  )
}
